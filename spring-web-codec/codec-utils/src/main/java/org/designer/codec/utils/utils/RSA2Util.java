 ...
 */
public final class RSA2Util implements Encryption {
    ...
    public String encrypt(String content, EncryptInfo encryptInfo) {
        return buildRSAEncryptByPrivateKey(content, encryptInfo.getPrivateKey());
    }
    ...
    public boolean verify(String content, VerifyInfo verifyInfo) {
        return buildRSAVerifyByPublicKey(content, verifyInfo.getPublicKey(), verifyInfo.getSign());
    }
}