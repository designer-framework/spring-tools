...
@Getter
@Log4j2
public abstract class AbstractEncryptBeanInfo extends AbstractCodecBeanInfo {

    private static final long serialVersionUID = -2488641171866509257L;

    public AbstractEncryptBeanInfo(EncryptInfo encryptInfo) {
        super(encryptInfo);
    }

    public AbstractEncryptBeanInfo(VerifyInfo encryptInfo) {
        super(encryptInfo);
    }
